        ...
        try {
            ...
            for (const date of datesInRange) {
                ...
                if (doc.exists) {
                    ...
                    allDaysHTML += `<div class="daily-record"><h3>盤點日期：${date}</h3><p><strong>盤點護理師：</strong>${dailyData.header.nurse||''} &nbsp;&nbsp;&nbsp; <strong>補齊者：</strong>${dailyData.header.restocker||''}</p>${dailyTable}</div>`;
                }
            }
