              ...
              <div class="row g-4" id="popupBodyWrap">
                <div class="col-lg-5">
                  <div class="popup-section h-100">
                    <div class="popup-section-head"><div><div class="fw-bold">提醒事項</div><div class="small text-muted">以下為今日及未來之提醒事項(僅你可見)</div></div><span class="count-chip" id="popupReminderCount">0</span></div>
                ...
                <div class="col-lg-7">
                  <div class="popup-section h-100">
                    <div class="popup-section-head"><div><div class="fw-bold">代辦事項</div><div class="small text-muted">以下為待處理或待審核之系統事項</div></div><span class="count-chip" id="popupTodoCount">0</span></div>
                    <div class="popup-section-body popup-scroll">
