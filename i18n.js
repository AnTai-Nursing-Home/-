const translations = {
    ...
    'en': {
        ...
        'not_set': 'Not set',
        'read_list_failed': 'Failed to load list.',
        ...
        'please_fill_resident_name': 'Please fill in resident\'s name.',
        'please_fill_visitor_name': 'Please fill in your name.',
        'please_fill_visitor_relationship': 'Please fill in your relationship to the resident.',
        'please_fill_contact_phone': 'Please fill in your contact phone.',
        'confirm_booking_info_title': 'Please confirm your booking information',

        // --- Nurse/Caregiver System (Common) ---
        ...
        'employee_data_management': 'Employee Data Management',
        ...
        'fill_resident_name': 'Resident name is required!',
        ...
        'ongoing': 'Ongoing',
        'assessment_items': 'Daily Assessment Items',
        'signature': 'Signature',
        'caregiver': 'Caregiver',
        'nurse': 'Nurse',
        'hand_hygiene': '1. Hand Hygiene',
        'fixed_position': '2. Fixed Position',
        'unobstructed_drainage': '3. Unobstructed Drainage',
        'avoid_overfill': '4. Avoid Overfill',
        'urethral_cleaning': '5. Urethral Cleaning',
        'single_use_container': '6. Single Use Container',
        'yes': 'Yes',
        'no': 'No',
        'save_this_care_form': 'Save This Care Form',
        'delete_this_care_form': 'Delete This Care Form',
        'back_to_list': 'Back to List',
        'fill_form_first': 'Please select a resident and fill in the placement date first!',
        'care_form_saved': 'Care form has been saved successfully!',
