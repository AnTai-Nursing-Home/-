const translations = {
    'zh-TW': {
        // --- 通用 ---
        'caregiver_login_title': '請輸入個人帳號密碼',
        'login_user_label': '登入者名稱:',
        'username_employee_id': '帳號（員工編號）',
        'password': '密碼',
        'agree_terms': '我同意',
        'service_agreement': '《安泰醫療社團法人附設安泰護理之家服務系統使用協議》',
        'new_staff_notice': '※ 若新員工尚未建立帳號請告知主任。',
        'logout': '登出',
        'agree_terms_alert': '請先勾選同意《安泰醫療社團法人附設安泰護理之家服務系統使用協議》',
        'enter_username_password': '請輸入帳號與密碼',
        'no_caregiver_permission': '此帳號沒有照服員系統權限',
        'login_failed_try_later': '登入時發生錯誤，請稍後再試',
...
'unsaved_cancel': '取消',
    ...
    'en': {
        // --- Common ---
        'caregiver_login_title': 'Please enter your personal account and password',
        'login_user_label': 'Logged-in user:',
        'username_employee_id': 'Username (Employee ID)',
        'password': 'Password',
        'agree_terms': 'I agree to',
        'service_agreement': 'Antai Nursing Home System Service Agreement',
        'new_staff_notice': '* If a new staff member does not have an account, please inform the supervisor.',
        'logout': 'Logout',
        'agree_terms_alert': 'Please check the box to agree to the Service Agreement first.',
        'enter_username_password': 'Please enter username and password.',
        'no_caregiver_permission': 'This account does not have access to the Caregiver System.',
