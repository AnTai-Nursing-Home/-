...
function renderStats(){
    ...
    statsArea.innerHTML = '<div class="row g-3">' +'<div class="col-md-6">' +'<div class="card"><div class="card-body">' +'<div class="table-responsive mt-3">' +'<table class="table table-sm align-middle mb-0">' +'<thead class="table-light"><tr><th>樓層</th><th class="text-end">輪椅</th><th class="text-end">推床</th><th class="text-end">步行</th></tr></thead>' +'<tbody>' +'<tr><td>1F</td><td class="text-end>'" + mob[0].wheel + "'</td><td class="text-end">' + mob[0].trolley + '</td><td class="text-end">' + mob[0].walk + '</td></tr>' +'<tr><td>2F</td><td class="text-end">' + mob[1].wheel + '</td><td class="text-end">' + mob[1].trolley + '</td><td class="text-end">' + mob[1].walk + '</td></tr>' +'<tr><td>3F</td><td class="text-end">' + mob[2].wheel + '</td><td class="text-end">' + mob[2].trolley + '</td><td class="text-end">' + mob[2].walk + '</td></tr>' +'</tbody></table></div></div></div>' +'</div>' +'<div class="col-md-6">' +'<div class="card"><div class="card-body text-end">' +'<button id="export-xls-styled" class="btn btn-success btn-sm">' +'<i class="fa-solid fa-file-excel me-1"></i>匯出 Excel（含框線與底色）</button>' +'</div></div>' +'</div>' +'</div>';
