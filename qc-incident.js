...
function showGlobalLoading(text = "讀取中..."){
...
function buildYearSelect(){
  ...
  sel.onchange = async () => {
    ...
    if (currentMonth) await showMonthDetail(currentMonth);
    else await showMonthsView();
  };
}
